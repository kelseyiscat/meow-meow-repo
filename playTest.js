...
// --- Demo / Play ---
console.log('🎲 Random Generator Demo');
console.log('Random Int (1–100):', randomInt(1, 100));
console.log('Random Float (0–1):', randomFloat(0, 1));
console.log('Random Choice:', randomChoice(['apple', 'banana', 'cherry', 'date', 'elderberry']));
