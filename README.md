...
| `what-is-an-agent/` | A simple static landing page explaining what an AI agent is |
...
- **[The Tiny Adventure of Mochi](./cute-cat)** — a curious kitten, a runaway leaf, and a sunny garden.
